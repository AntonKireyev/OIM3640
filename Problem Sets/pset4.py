...
Print a message something like "That was fast. It took you 0.212 seconds to hit enter", note the time value should be based on a variable you calculate
Take a screenshot of your code and a sample run, paste into your submission document
